defmodule Fixtures do
  def ua do
    %{
      ...
      "DAUMOA" => "ozilla/5.0 (compatible; MSIE or Firefox mutant; not on Windows server;) Daumoa 4.",
      ...
      "IE_WITHOUT_TRIDENT" => "ozilla/4.0 (compatible; MSIE8.0; Windows NT 6.0) .NET CLR 2.0.50727",
